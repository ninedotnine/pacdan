...
CFLAGS = -std=c11 -Wall -Wextra -g -pedantic -march=native -pipe -ggdb -Os -Werror -Wundef -Wcast-align -Wwrite-strings -Wunreachable-code -Wformat=2 -fdelete-null-pointer-checks -Winit-self -Wunused-result -Wstrict-aliasing -Wimplicit-fallthrough
FILES = src/main.c
OUT_EXE = bin/pacdan
